...
Here `a` and `v` are vectors of length 3 containing convex weights and `VertexGLM` objects, respectively.
...
function stable_eval_mm_weight(t::Integer, a, v::NTuple{3,T}, y, x) where T <: VertexGLM
